...
$id = $_GET['id'];
$methodData = $controller->getPaymentMethod($id);
...
if (isset($_POST['update'])) {
    ...
    if ($method !== '') {
        if ($controller->editPaymentMethod($id, $method)) {
            header('location: payment_method_list.php?update_status=success');
            exit;
        }
    } else {
        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-4">
                    <h3 class="text-center mb-4">Edit Payment Method</h3>
                    <form method="post">
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <a href="payment_method_list.php" class="btn btn-outline-secondary px-4">← Back</a>
                        </div>
                    </form>
                </div>
            </div>
